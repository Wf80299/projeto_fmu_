...
if (isset($_POST['email']) || isset($_POST['password'])) {
    ...
    if (strlen($_POST['email']) == 0) {
        ...
        $sql_query = $mysqli->query($sql_pesquisa) or die("Erro de pesquisa query" . $mysqli->error); // Executar a variavel (query) no banco de dados pesquisando email e senha 

        $quantidade = $sql_query->num_rows; // Armazenar o numero de linhas da pesquisa email e senha em uma variavel 
